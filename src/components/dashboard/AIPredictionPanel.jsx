...
function AIPredictionPanel({ latestReading, isEnabled = true }) {
        ...
        <div className="text-center">
          ...
          {!canPredict && !isLoading && (
            <p className="text-sm text-gray-500 mt-3">
              {!latestReading
                ? "📊 Generate a spectrometer reading first"
                : !isEnabled
                ? "⏸️ AI predictions temporarily disabled"
                : "📋 Ready to analyze composition data"}
            </p>
          )}
        </div>
            ...
            <div className="flex items-start">
              ...
              <div className="text-sm">
                ...
                <div className="text-blue-700 space-y-1">
                  <p>
                    • Analyzes current composition against target specifications
                  </p>
